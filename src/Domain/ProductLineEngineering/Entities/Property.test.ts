...
test('The constructor should give the right values', () => {
  ...
  let property= new Property('test_name','test_value','test_type','test_option','test_linked_property','test_linked_value',false,false,'test_comment','test_possible_value', null, null , null, null, null, null);
